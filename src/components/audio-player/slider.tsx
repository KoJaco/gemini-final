...
export function Slider(
    ...
    return (
        <div
            {...groupProps}
            className="inset-y-10 h-full left-full flex flex-col flex-auto touch-none items-center gap-6 absolute">
            {props.label && (
            ...
            <div
                ...
                ref={trackRef}
                className="relative w-full bg-muted-foreground rounded-full">
                <div
                    className={clsx(
                        "w-2 rounded-t-xl rounded-b-xl h-full",
